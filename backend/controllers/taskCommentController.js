...
createComment: async (req, res) => {
  ...
  try {
    ...
    // Récupérer le commentaire complet avec les informations utilisateur
    const commentWithUser = await TaskComment.getWithUserById(comment.id, transaction);
  ...
  getTaskComments: async (req, res) => {
    try {
      ...
      // Récupérer les commentaires avec les infos de l'utilisateur en utilisant la méthode du modèle
      const comments = await TaskComment.getWithUser(taskId);
  ...
  updateComment: async (req, res) => {
    ...
    try {
      ...
      // Trouver le commentaire
      const comment = await TaskComment.findByPk(commentId, { transaction });
